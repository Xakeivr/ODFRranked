...
class ConfigManager:
    public_keys = {
        # activity
        "twitch_url": "https://www.twitch.tv/xakei_/",
        # bot settings
        ...
        # logging
        "log_channel_id": 1345034304098402364,
        "mention_channel_id": 1483587953534963793,
        "update_channel_id": 1483588199547928658,
        # updates
        ...
        "use_nickname_channel_name": True,
        ...
        "private_added_to_group_description_anon": "A ODFR Staff has added you to a Modmail thread.",
        "public_added_to_group_title": "New User",
        "public_added_to_group_response": "{moderator.name} has added {users} to the Modmail thread.",
        "public_added_to_group_description_anon": "A ODFR Staff has added {users} to the Modmail thread.",
        ...
        "private_removed_from_group_description_anon": "A ODFR Staff has removed you from the Modmail thread.",
        ...
        "public_removed_from_group_description_anon": "A ODFR Staff has removed {users} from the Modmail thread.",
        # moderation
        "recipient_color": str(discord.Color.gold()),
        "mod_color": str(discord.Color.green()),
        "mod_tag": None,
        # anonymous message
        "anon_username": "ODFR Staff",
        "anon_avatar_url": "./image/",
        "anon_tag": "Response",
        # react to contact
